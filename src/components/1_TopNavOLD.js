...
const TopNav = () => {
  ...
  console.log(sideNav);
  return (
    <div className="max-w-[1520] min-w-[300px] mx-auto flex justify-between items-center p-2 ml-[-15px]">
      ...
      <div className="hidden ssm:flex items-center ml-2">
        <button className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:outline-none dark:focus:ring-blue-800 border-blue-600 shadow-lg shadow-blue-500/50 text-xl hidden lg:flex py-2 rounded-[15px] px-3 mr-2">
