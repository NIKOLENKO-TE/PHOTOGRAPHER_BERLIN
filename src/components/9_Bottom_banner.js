...
const BottomBanner = () => {
    return (
        <div className="sm:hidden  fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-white rounded-full bottom-4 left-1/2 dark:bg-gray-700">
            <div className="grid h-full max-w-lg grid-cols-5 mx-auto bg-white">
