...
const TopNav = () => {
  ...
  console.log(sideNav);
  return (
    <div className="max-w-[1520] min-w-[300px] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center ">
        <div onClick={() => setSideNav(!sideNav)} className="cursor-pointer">
          <MdDragIndicator size={50} />
        </div>
        <div className="bg-gray-200 rounded-full p-1 text-xl ssm:w-[300px] sm:w-[380px]">
          <div className="justify-left hidden ssm:flex h-[42px] ">  
            <h1 className="flex text-justify justify-center bg-orange-700 text-white rounded-full p-1.5 ssm:w-[300px] sm:w-[390px] md:w-[390px]">
      ...
      <div className="hidden ssm:flex items-center ml-2">
        ...
        <button className="bg-violet-500 hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 text-white hidden md:flex text-xl py-2 rounded-full">
          <FaTelegram size={30} />
