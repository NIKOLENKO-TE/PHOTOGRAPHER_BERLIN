...
const Footer = () => {
  ...
  const nikolenkoteContainer = <div className="w-full mt-2 sm:w-[48%] md:w-[40%] lg:w-[30%]">
  ...
  const socialMediaContainer = <div className="w-full mt-2 sm:w-[52%] md:w-[60%] lg:w-[40%]">
  ...
  const followMeContainer = <div className="w-screen mt-2 mb-[20px] pr-2 ssm:pl-2 md:pl-0 sm:w-[80%] md:w-[80%] lg:w-[30%]">
