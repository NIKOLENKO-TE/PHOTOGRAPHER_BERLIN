...
const Photosessions = () => {
  ...
  const HorizontalThumbnailCarousel = (
    <section id="horizontal_thumbnail_carousel" ref={splideRefHorizontal} className="splide pb-2 pt-0.5">
  ...
  const VerticalThumbnailCarousel = (
    <section id="vertical_thumbnail_carousel" ref={splideRefVertical} className="splide pb-2 pt-0.5">
      <div className="splide__track rounded-2xl">
        <ul className="splide__list">
  ...
  const HorizontalThumbnailCarouselPreview = (
    <section id="horizontal_thumbnail_carousel_preview" ref={previewSplideRefHorizontal} className="splide">
