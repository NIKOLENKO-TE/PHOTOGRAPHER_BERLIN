...
const Childrens = () => {
  ...
  const ChildrensTitle = (
    <h3 className="flex justify-center mb-1 uppercase" data-testId="childrens-title">
  ...
  return (
    <div className={CarouselBackgroundStyle} id={`category${2}`} data-testId="childrens-wrapper">
      {ChildrensTitle}
      {ThumbnailCarousel}
